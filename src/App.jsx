...
function ProductIntelligence({tickets,lines,previousTickets,previousLines,articles,costMap,range,onCostSaved}){
...
function BusinessIntelligence({view='resumen',onNavigate}){
 ...
 const products=<ProductIntelligence tickets={bi.tickets} lines={bi.lines} previousTickets={previous.tickets||[]} previousLines={previous.lines||[]} articles={bi.articles} costMap={bi.costMap} range={r} onCostSaved={load}/>;
...
function pctDelta(current,previous){if(!previous)return current?100:0;return (current-previous)/Math.abs(previous)*100}
