...
function UnifiedProfitability(){
 ...
 {detail&&<div className="modal"><div className="modalbox unifiedProfitDetail"><div className="row between"><h2>{detail.title}</h2><button onClick={()=>setDetail(null)}>Cerrar</button></div><div className="profitDetailList">{detail.rows.map((x,i)=><p className="profitDetailRow" key={i}><span>{x[0]}</span><b>{x[1]}</b></p>)}</div></div></div>}</div>
}
